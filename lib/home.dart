      ...
      return Scaffold(
        ...
        appBar:PreferredSize(
          ...
          child: AppBar(
            ...
            title: Text('Circle Network',style: TextStyle(fontSize: x/30,color: Colors.white),),
                                        ...
                                        child: new InkResponse(
                                          child: new Column(
                                            ...
                                            children: <Widget>[
                                              ...
                                              new SizedBox(height: 3,),
                                              new Text('Live Tv',textAlign: TextAlign.center,style: TextStyle(fontSize: wi/15,color: Colors.white,)),
                                            ],
                                          ),
                                          onTap: () {
                                            Navigator.push(context, MaterialPageRoute(builder: (context) => LiveTv1()),);
